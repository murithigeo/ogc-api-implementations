...
const hourlyWeather = (sequelize: Sequelize) => {
  return sequelize.define(
    "hourly2024",
    {
      ...
      date: DataTypes.DATE, //Is datetime column
      source: DataTypes.STRING,
      name: DataTypes.STRING, //Name of station
      report_type: DataTypes.STRING, //FM-12 is a SYNOP report
      call_sign: DataTypes.STRING, //USAF identifier. 99999 indicates missing
      quality_control: DataTypes.STRING, //Quality Control Process Code
      wnd: DataTypes.ARRAY(DataTypes.STRING), //Wind: Typical format: dddff(f)gddff(f) =>ddd(wind Direction in degrees), g (gusts), ddff(f) (gust speed)
      ...
      tmp: DataTypes.ARRAY(DataTypes.STRING), //Temperature: Example +0280,1 (Temps in tenths of degrees)=>28.0*C
