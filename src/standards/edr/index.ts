...
const collectionsMetadata: types.CollectionWithoutProps[] = [
  {
    ...
    edrVariables: [
      {
        columnProperties: { name: "dew", arrayIndex: 1 },
      ...
      },
      {
        ...
        name: "temperature",
        unit: "temperature",
        columnProperties: { name: "temperature", arrayIndex: 1 },
        scalingFactor: 10,
      },
      {
        columnProperties: { name: "slp", arrayIndex: 1 },
        id: "pressure",
        dataType: "float",
        name: "pressure",
        unit: "pressure",
      ...
      {
        columnProperties: { name: "wind", arrayIndex: 1 },
        id: "windDirection",
        dataType: "integer",
        name: "windDirection",
        unit: "windDirection",
      ...
      {
        columnProperties: { name: "wind", arrayIndex: 3 },
        id: "windType",
        dataType: "string",
        name: "windType",
        unit: "windType",
      ...
      {
        columnProperties: { name: "wind", arrayIndex: 4 },
        id: "windSpeed",
        dataType: "float",
        name: "windSpeed",
        unit: "windSpeed",
